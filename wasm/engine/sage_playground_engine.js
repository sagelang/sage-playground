...
export class RunResult {
    ...
    get result() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.runresult_result(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get success() {
        const ret = wasm.runresult_success(this.__wbg_ptr);
        return ret !== 0;
    }
}
 ...
 * @returns {RunResult}
 */
export function run_sage(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_sage(ptr0, len0);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sage_playground_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sage_playground_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
